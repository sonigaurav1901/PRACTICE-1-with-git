...
export default class ChildCompOfpCObj extends LightningElement {
   ...
   // activeSectionMessage = '';
    ...
    //     this.x_value = event.detail.openSections;

    //     // console.log('hell ',event.detail);
    //     // console.log('hell 1 ',event.detail.value);
    //     console.log('Object Name --> ',this.x_value);
    // }
